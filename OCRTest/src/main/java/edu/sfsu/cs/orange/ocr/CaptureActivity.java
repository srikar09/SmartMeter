...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
  ...
  void sendMessageOCR(String ocrText) throws IOException, GeneralSecurityException {
      String SpreadsheetURL = "https://script.google.com/macros/s/AKfycbyK9cH6CnWsjdPXCugUXIrHq5XrzRJ0IUQ1CZ2810O0QjBxQwM/exec?sheet=cristo";
      String uniqueID = Settings.Secure.getString(getContentResolver(), Settings.Secure.ANDROID_ID);
      String sheet = "cristo"; // is currently hard coded should change it
